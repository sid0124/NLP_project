...
export const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { id: "papers", label: "My Papers", icon: "papers", built: false, capability: "corpus" },
      { id: "search", label: "Search Papers", icon: "search", built: false, capability: "corpus" },
      {
        id: "compare",
      ...
      { id: "ask", label: "Ask a Paper", icon: "chat", built: false, capability: "rag_ask" },
    ],
  },
  {
    group: "Analytics",
    items: [
      { id: "trends", label: "Research Trends", icon: "trend", built: false, capability: "trends" },
      { id: "topics", label: "Topic Modeling", icon: "pie", built: false },
      { id: "citations", label: "Citation Network", icon: "graph", built: false },
      { id: "gaps", label: "Research Gaps", icon: "gap", built: false, capability: "research_gaps" },
    ],
  },
  {
    group: "Tools",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "keys", label: "API Keys", icon: "key", built: false, capability: "authentication" },
